...
namespace TP01_ALFIE_FAINSCHTEIN.Models
{
 ...
 Integrante liam = new Integrante(12345678, "Liam   Galanternik",  new DateTime(2010,01,05), "liam.jpg",  new List<string>{ "Mamá: Romina Lopez ", "Papá: Nicolas Galanternik"},  new List<string>{"Viajar", "Leer"} );
